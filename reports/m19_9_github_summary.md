# M19.9 — GitHub Summary: Churn Risk Business Findings

## Overview

M19.9 translates the completed churn-risk analysis into business-facing findings suitable for portfolio presentation.

The analysis evaluates a Random Forest churn-risk model under the established M19 prediction contract and focuses on the practical trade-off between churn capture and targeting efficiency.
